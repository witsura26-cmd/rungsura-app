...
const SONGS = [
  {"id":"เจ็บตรงนี้-lamyai-haitongkam","titleEn":"Jeb Trong Nee","titleTh":"เจ็บตรงนี้","artistEn":"Lamyai Haitongkam","artistTh":"ลำไย ไหทองคำ","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["เจ็บตรงนี้ เจ็บตรงกลางอก","เจ็บที่ต้องปลง เจ็บที่ต้องทน"]},{"type":"verse","num":2,"repeat":false,"lines":["เจ็บที่รู้ว่าเธอไม่รักกันแล้ว","แต่ยังต้องเจอหน้ากันทุกวัน"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["จะทำยังไงให้ลืมเธอไปได้"]},{"type":"chorus","num":null,"repeat":false,"lines":["เจ็บตรงนี้ เจ็บที่ใจดวงนี้","เจ็บที่ต้องยิ้มทั้งที่น้ำตาจะไหล"]},{"type":"verse","num":3,"repeat":false,"lines":["เวลาจะช่วยเยียวยาได้ไหม","หรือฉันต้องทนเจ็บแบบนี้ไปตลอด"]},{"type":"chorus","num":null,"repeat":true,"lines":["เจ็บตรงนี้ เจ็บที่ใจดวงนี้","เจ็บที่ต้องยิ้มทั้งที่น้ำตาจะไหล"]},{"type":"bridge","num":null,"repeat":false,"lines":["สักวันคงจะดีขึ้น","สักวันคงจะลืมเธอได้"]},{"type":"chorus","num":null,"repeat":true,"lines":["เจ็บตรงนี้ เจ็บที่ใจดวงนี้","เจ็บที่ต้องยิ้มทั้งที่น้ำตาจะไหล"]},{"type":"outro","num":null,"repeat":false,"lines":["เจ็บตรงนี้..."]}]},
  {"id":"ยายแล่ม-lamyai-haitongkam","titleEn":"Yai Laem","titleTh":"ยายแล่ม","artistEn":"Lamyai Haitongkam","artistTh":"ลำไย ไหทองคำ","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["ยายแล่มเอ๋ย ยายแล่ม","อยู่บ้านนอกทำนาปลูกข้าว"]},{"type":"chorus","num":null,"repeat":false,"lines":["ยายแล่มยิ้มหวาน ยายแล่มใจดี","ยายแล่มเป็นที่รักของหลานๆ"]},{"type":"verse","num":2,"repeat":false,"lines":["ยายเล่านิทานให้ฟังทุกคืน","ยายสอนให้เป็นคนดี"]},{"type":"chorus","num":null,"repeat":true,"lines":["ยายแล่มยิ้มหวาน ยายแล่มใจดี","ยายแล่มเป็นที่รักของหลานๆ"]}]},
  {"id":"โนบรา-โนราห์-biw-kalyanee","titleEn":"No Bra - Norah","titleTh":"โนบรา-โนราห์","artistEn":"Biw Kalyanee","artistTh":"บิ๊ว กัลยาณี","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["โนราห์เอ๋ยโนราห์ นางรำสวยงาม","ท่ารำอ่อนช้อยชวนมอง"]},{"type":"verse","num":2,"repeat":false,"lines":["เครื่องแต่งกายงดงามวิจิตร","ตามศิลปะโบราณ"]},{"type":"chorus","num":null,"repeat":false,"lines":["โนราห์ โนราห์ ศิลปะใต้","สืบทอดมาแต่บรรพบุรุษ"]},{"type":"verse","num":3,"repeat":false,"lines":["ดนตรีกลองโหม่งเสียงดังกังวาน","เร่งจังหวะให้รำสวยงาม"]},{"type":"chorus","num":null,"repeat":true,"lines":["โนราห์ โนราห์ ศิลปะใต้","สืบทอดมาแต่บรรพบุรุษ"]},{"type":"bridge","num":null,"repeat":false,"lines":["ขอให้ศิลปะนี้อยู่คู่ไทย","ตลอดไป ตลอดไป"]},{"type":"instrumental","num":null,"repeat":false,"lines":["— 🥁 —"]},{"type":"chorus","num":null,"repeat":true,"lines":["โนราห์ โนราห์ ศิลปะใต้","สืบทอดมาแต่บรรพบุรุษ"]}]},
  {"id":"คิดฮอด-bodyslam","titleEn":"Kid Hod","titleTh":"คิดฮอด","artistEn":"Bodyslam","artistTh":"บอดี้สแลม","artistIcon":"🎸","sections":[{"type":"verse","num":1,"repeat":false,"lines":["ไกลแค่ไหนก็คิดถึงเธอ","ทุกลมหายใจยังมีเธอเสมอ"]},{"type":"verse","num":2,"repeat":false,"lines":["แม้ระยะทางจะกั้นขวาง","ใจยังคงผูกพันไม่เปลี่ยนแปลง"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["คิดฮอด คิดฮอดจนอยากบอกเธอ"]},{"type":"chorus","num":null,"repeat":false,"lines":["คิดฮอดคิดฮอด คิดถึงเธอทุกวัน","แม้ไกลกันแค่ไหนใจยังผูกพัน"]},{"type":"verse","num":3,"repeat":false,"lines":["วันเวลาผ่านไปเท่าไหร่","ความคิดถึงยังไม่จางหาย"]},{"type":"chorus","num":null,"repeat":true,"lines":["คิดฮอดคิดฮอด คิดถึงเธอทุกวัน","แม้ไกลกันแค่ไหนใจยังผูกพัน"]},{"type":"bridge","num":null,"repeat":false,"lines":["สักวันจะได้กลับไปหาเธอ","สักวันจะได้บอกรักเธออีกครั้ง"]},{"type":"instrumental","num":null,"repeat":false,"lines":["— 🎸 —"]},{"type":"chorus","num":null,"repeat":true,"lines":["คิดฮอดคิดฮอด คิดถึงเธอทุกวัน","แม้ไกลกันแค่ไหนใจยังผูกพัน"]}]},
  {"id":"กุหลาบ-f-hero-feat-ก้านตอง-x-saran","titleEn":"Kularb","titleTh":"กุหลาบ","artistEn":"F.HERO feat. Kantong x SARAN","artistTh":"เอฟ ฮีโร่ feat. ก้านตอง x สราญ","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["กุหลาบสวยงามมีหนาม","เหมือนความรักที่งดงามแต่เจ็บปวด"]},{"type":"verse","num":2,"repeat":false,"lines":["เธอคือกุหลาบของฉัน","สวยงามที่สุดในสวนดอกไม้"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["แม้จะมีหนามคอยทิ่มแทง"]},{"type":"chorus","num":null,"repeat":false,"lines":["กุหลาบ กุหลาบของฉัน","ถึงจะเจ็บก็ยังอยากดูแล"]},{"type":"verse","num":3,"repeat":false,"lines":["ทุกหนามที่เธอมี ฉันรับได้","เพราะรักเธอมากกว่าความเจ็บปวด"]},{"type":"chorus","num":null,"repeat":true,"lines":["กุหลาบ กุหลาบของฉัน","ถึงจะเจ็บก็ยังอยากดูแล"]},{"type":"bridge","num":null,"repeat":false,"lines":["ไม่ว่าจะเจ็บแค่ไหน","ฉันจะดูแลเธอตลอดไป"]},{"type":"instrumental","num":null,"repeat":false,"lines":["— 🎹 —"]},{"type":"chorus","num":null,"repeat":true,"lines":["กุหลาบ กุหลาบของฉัน","ถึงจะเจ็บก็ยังอยากดูแล"]},{"type":"outro","num":null,"repeat":false,"lines":["กุหลาบของฉัน..."]}]},
  {"id":"last-hope-paramore","titleEn":"Last Hope","titleTh":"",  "artistEn":"Paramore","artistTh":"","artistIcon":"🎸","sections":[{"type":"verse","num":1,"repeat":false,"lines":["There's a light, there's a sun","Taking all the space that you thought you were owed"]},{"type":"verse","num":2,"repeat":false,"lines":["And I'm scraping and crawling","And I hope that it opens the door"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["It's alright, it's okay","We all gotta find our way"]},{"type":"chorus","num":null,"repeat":false,"lines":["Sometimes making a mistake feels like","The best mistake I ever made"]},{"type":"verse","num":3,"repeat":false,"lines":["'Cause the light you feel","Will set you apart from the ones who felt total"]},{"type":"chorus","num":null,"repeat":true,"lines":["Sometimes making a mistake feels like","The best mistake I ever made"]},{"type":"bridge","num":null,"repeat":false,"lines":["I know it's hard to remember","Sometimes before it gets better"]},{"type":"instrumental","num":null,"repeat":false,"lines":["— 🎸 —"]},{"type":"chorus","num":null,"repeat":true,"lines":["Sometimes making a mistake feels like","The best mistake I ever made"]},{"type":"outro","num":null,"repeat":false,"lines":["This is my last hope"]}]},
  ...
  {"id":"die-on-this-hill-sienna-spiro","titleEn":"Die on This Hill","titleTh":"","artistEn":"Sienna Spiro","artistTh":"","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["I've been standing here for hours","Fighting for what I believe"]},{"type":"verse","num":2,"repeat":false,"lines":["They keep telling me to quit","But I'm not backing down easily"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["So call me stubborn, call me proud"]},{"type":"chorus","num":null,"repeat":false,"lines":["I will die on this hill","I won't back down, I never will"]},{"type":"verse","num":3,"repeat":false,"lines":["You can push, you can shove","But you can't move what I love"]},{"type":"chorus","num":null,"repeat":true,"lines":["I will die on this hill","I won't back down, I never will"]},{"type":"bridge","num":null,"repeat":false,"lines":["Maybe I'm wrong, maybe I'm right","Either way I'll stand and fight"]},{"type":"chorus","num":null,"repeat":true,"lines":["I will die on this hill","I won't back down, I never will"]}]},
  {"id":"blinding-lights-the-weeknd","titleEn":"Blinding Lights","titleTh":"","artistEn":"The Weeknd","artistTh":"","artistIcon":"🎤","sections":[{"type":"verse","num":1,"repeat":false,"lines":["I've been tryna call","I've been on my own for long enough","Maybe you can show me how to love, maybe","I'm going through withdrawals","You don't even have to do too much","You can turn me on with just a touch, baby"]},{"type":"pre-chorus","num":null,"repeat":false,"lines":["I look around and","Sin City's cold and empty","No one's around to judge me","I can't see clearly when you're gone"]},{"type":"chorus","num":null,"repeat":false,"lines":["I said, ooh, I'm blinded by the lights","No, I can't sleep until I feel your touch","I said, ooh, I'm drowning in the night","Oh, when I'm like this, you're the one I trust"]},{"type":"verse","num":2,"repeat":false,"lines":["I'm running out of time","'Cause I can see the sun light up the sky","So I hit the road in overdrive, baby","Oh, the city's cold and empty (oh)","No one's around to judge me (oh)","I can't see clearly when you're gone"]},{"type":"chorus","num":null,"repeat":true,"lines":["I said, ooh, I'm blinded by the lights","No, I can't sleep until I feel your touch","I said, ooh, I'm drowning in the night","Oh, when I'm like this, you're the one I trust"]},{"type":"bridge","num":null,"repeat":false,"lines":["I'm just walking by to let you know (by, by, by)","I can never say it on the phone (phone)","Will never let you go this time (ooh)","","I said, ooh, I'm blinded by the lights","No, I can't sleep until I feel your touch"]},{"type":"instrumental","num":null,"repeat":false,"lines":["— 🎹 —"]},{"type":"chorus","num":null,"repeat":true,"lines":["I said, ooh, I'm blinded by the lights","No, I can't sleep until I feel your touch","I said, ooh, I'm drowning in the night","Oh, when I'm like this, you're the one I trust"]},{"type":"outro","num":null,"repeat":false,"lines":["I can't sleep until I feel your touch"]}]},
...
let songLyricsFontSize = 12; // always starts at 12pt fresh — not persisted across sessions
